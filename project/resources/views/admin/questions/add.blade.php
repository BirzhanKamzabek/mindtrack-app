 ...
 <!-- Main content -->
  <section class="content">
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
				...
				@endif
				<form role="form" action="{{route('admin.add_questions_action')}}" method="POST" enctype='multipart/form-data'>
					@CSRF
					<div class="box-body">
          <div class="col-md-12">
    ...
    <div class="form-group">
        ...
        <input type="text" name="question" class="form-control @error('name') is-invalid @enderror" id="exampleInputEmail1" placeholder="Name" value="{{ old('name') }}" >
    </div>
</div>
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-with-checkbox">
                <input type="text" name="option1" class="form-control @error('option1') is-invalid @enderror" id="exampleInputEmail1" placeholder="Option 1" value="{{ old('option1') }}" step="any">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-with-checkbox">
                <input type="text" name="option2" class="form-control @error('option2') is-invalid @enderror" id="exampleInputEmail1" placeholder="Option 2" value="{{ old('option2') }}">
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-with-checkbox">
                <input type="text" name="option3" class="form-control @error('option3') is-invalid @enderror" id="exampleInputEmail1" placeholder="Option 3" value="{{ old('option3') }}" step="any">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-with-checkbox">
                <input type="text" name="option4" class="form-control @error('option4') is-invalid @enderror" id="exampleInputEmail1" placeholder="Option 4" value="{{ old('option4') }}">
                <input type="checkbox" name="answer" value="option4">
            </div>
        </div>
    </div>
</div>
