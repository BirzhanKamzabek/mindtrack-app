        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Adsense</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"> Add Adsense</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
				...
				@endif
				<form role="form" action="{{route('admin.add_adsense_action')}}" method="POST" enctype='multipart/form-data'>
					@CSRF
					<div class="box-body">
...
<img src="" alt="" id="banner-preview" width="400px">
						</div>
